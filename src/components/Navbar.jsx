      ...
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        >
          <li className="hover:text-btnColor font-[500]  transition-all duration-150">
            <Link
              className={`${
                path === "/" ? "text-white font-semibold border-b-2 border-white" : "text-gray-200"
              }`}
              to="/"
            >
              Home
          ...
          <li className="hover:text-btnColor font-[500]  transition-all duration-150">
            <Link
              className={`${
                path === "/shortenUrl" ? "text-white font-semibold border-b-2 border-white" : "text-gray-200"
              }`}
              to="/shortenUrl"
            >
              Shorten URL
          ...
          <li className="hover:text-btnColor font-[500]  transition-all duration-150">
            <Link
              className={`${
                path === "/about" ? "text-white font-semibold border-b-2 border-white" : "text-gray-200"
              }`}
              to="/about"
            >
              About
          ...
          {token && (
            ...
            <Link
              className={`${
                path === "/dashboard" ? "text-white font-semibold border-b-2 border-white" : "text-gray-200"
              }`}
              to="/dashboard"
            >
              Dashboard
