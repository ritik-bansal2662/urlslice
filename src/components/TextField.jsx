    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className={`${className || ""} ${inputClassName || ""} px-2 py-2 border outline-none bg-transparent text-slate-700 rounded-md 
            ...
            pattern:
              type === "email"
                ...
                : isSlug ? {
                  value:
                      /^[A-Za-z0-9_-]+$/,
                    message: "Allowed Characters: Uppercase and lower case alphabets, numbers(0-9), hyphen( - ) and underscore ( _ )"
                } : null,
          })}
        />
